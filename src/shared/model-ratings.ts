...
export const MODEL_RATINGS: Record<string, ModelRatings> = {
  ...
  'hviske-v5-tiny-f16': { speed: 9, accuracy: 9, languages: 1 },
  'hviske-v5-tiny-q4_k': { speed: 10, accuracy: 9, languages: 1 },
  'hviske-v5-tiny-q5_0': { speed: 10, accuracy: 9, languages: 1 },
  'hviske-v5-tiny-q6_k': { speed: 10, accuracy: 9, languages: 1 },
  'hviske-v5-tiny-q8_0': { speed: 10, accuracy: 9, languages: 1 },
