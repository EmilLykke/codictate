      ...
      <div className="mb-8">
        ...
        <label className="block">
          ...
          <input
            ...
            className="w-full rounded-lg border border-overlay/12 bg-overlay/5 px-4 py-3.5 text-[17px] font-medium text-overlay/78 outline-none transition-[border-color,background-color,box-shadow] duration-200 placeholder:text-overlay/24 hover:border-overlay/18 hover:bg-overlay/7 focus-visible:border-overlay/26 focus-visible:ring-2 focus-visible:ring-overlay/12 focus-visible:ring-offset-0"
          />
        </label>
      </div>
            ...
            return (
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 rounded-lg border px-3 py-2.5 text-[15px] font-medium cursor-pointer ${
                  selected
                    ? "border-overlay/22 bg-overlay/8 text-overlay/88"
                    : "border-overlay/11 bg-overlay/4 text-overlay/52 hover:border-overlay/16 hover:bg-overlay/6 hover:text-overlay/68"
                }`}
              >
                {icon}
                {label}
