    ...
    <Tooltip.Root>
      ...
      <Tooltip.Portal>
        <Tooltip.Content
          ...
          sideOffset={6}
          collisionPadding={10}
          className={`pointer-events-auto rounded-lg border border-white/14 bg-[#1c1c1f]/98 px-3 py-2 text-left text-[17px] leading-snug text-white/90 shadow-lg whitespace-normal z-[10000] ${tooltipClassName ?? ""}`}
        >
          {text}
        </Tooltip.Content>
      </Tooltip.Portal>
